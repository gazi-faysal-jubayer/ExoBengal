...
const StarWarsToggle: React.FC<StarWarsToggleProps> = ({ className = '' }) => {
...
const StyledWrapper = styled.div`
  ...
  .bb8-toggle {
    /* Further reduced size to be even smaller - was 10px, now 6px */
    --toggle-size: 6px;
  ...
  .bb8 {
    ...
    -webkit-transition: var(--transition) cubic-bezier(0.25, 0.46, 0.45, 0.94);
    -o-transition: var(--transition) cubic-bezier(0.25, 0.46, 0.45, 0.94);
  ...
  .bb8__body {
    ...
    position: relative;
    overflow: hidden;
    -webkit-transition: var(--transition) cubic-bezier(0.68, -0.55, 0.265, 1.55);
    -o-transition: var(--transition) cubic-bezier(0.68, -0.55, 0.265, 1.55);
  ...
  .bb8-toggle__checkbox:checked + .bb8-toggle__container .bb8 {
    ...
    -webkit-animation: bounceRight 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
    animation: bounceRight 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
  }
  ...
  .bb8-toggle__checkbox:checked + .bb8-toggle__container .bb8__body {
    -webkit-transform: rotate(765deg); /* Multiple full rotations for realistic rolling */
  ...
  /* Enhanced animations */
  .bb8-toggle:hover .bb8__body {
    -webkit-animation: wobble 0.3s ease-in-out;
  ...
  .bb8-toggle:hover .bb8__head-container {
    -webkit-animation: headBob 0.5s ease-in-out infinite alternate;
  ...
  .bb8-toggle__star:nth-child(2) { animation-delay: 0.5s; }
  .bb8-toggle__star:nth-child(3) { animation-delay: 1s; }
  .bb8-toggle__star:nth-child(4) { animation-delay: 1.5s; }
  .bb8-toggle__star:nth-child(5) { animation-delay: 2s; }

  @keyframes twinkle {
    0%, 100% { opacity: 1; filter: drop-shadow(0 0 0.063em #fff); }
    50% { opacity: 0.3; filter: drop-shadow(0 0 0.2em #fff); }
  }

  /* Enhanced rolling animation */
  .bb8__body {
    -webkit-animation: initialRotation 0.1s ease-in-out;
    animation: initialRotation 0.1s ease-in-out;
  }

  .bb8-toggle__checkbox:checked + .bb8-toggle__container .bb8__body {
    -webkit-animation: rollToRight 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
    animation: rollToRight 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
  }

  .bb8-toggle__checkbox:not(:checked) + .bb8-toggle__container .bb8__body {
    -webkit-animation: rollToLeft 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
    animation: rollToLeft 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
  }
  ...
  @keyframes rollToRight {
    ...
    75% { transform: rotate(540deg) scale(1.02); }
  ...
  /* Head animation during rolling */
  .bb8-toggle__checkbox:checked + .bb8-toggle__container .bb8__head-container {
    -webkit-animation: headRollRight 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
    animation: headRollRight 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
  }

  .bb8-toggle__checkbox:not(:checked) + .bb8-toggle__container .bb8__head-container {
    -webkit-animation: headRollLeft 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
    animation: headRollLeft 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
  }

  @keyframes headRollRight {
  ...
  /* BB-8 position bounce animations */
  @keyframes bounceRight {
    0% { left: var(--toggle-offset); }
    60% { left: calc(100% - var(--bb8-diameter) - var(--toggle-offset) + 8px); }
    80% { left: calc(100% - var(--bb8-diameter) - var(--toggle-offset) - 4px); }
    100% { left: calc(100% - var(--bb8-diameter) - var(--toggle-offset)); }
  }

  @keyframes bounceLeft {
    0% { left: calc(100% - var(--bb8-diameter) - var(--toggle-offset)); }
    60% { left: calc(var(--toggle-offset) - 8px); }
    80% { left: calc(var(--toggle-offset) + 4px); }
    100% { left: var(--toggle-offset); }
  }

  .bb8-toggle__checkbox:not(:checked) + .bb8-toggle__container .bb8 {
    -webkit-animation: bounceLeft 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
    animation: bounceLeft 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
  }
`
