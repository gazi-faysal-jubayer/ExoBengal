...
export const Component = () => {
  ...
  return (
   <footer className="my-8 px-4 max-w-7xl text-base-content mx-auto">
      <div className="relative bg-white dark:bg-dark-surface rounded-3xl max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-4 md:gap-10 px-2 md:px-8 flex-1">
          <div className='flex flex-col items-start gap-2'>
            ...
            <p className='text-light-text-secondary dark:text-dark-text-secondary font-medium text-base w-full md:w-4/5'>
              Explore the cosmos with our interactive exoplanet data visualization platform. Powered by NASA Exoplanet Archive.
            </p>
          </div>
      ...
      <div className="my-3 px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm text-light-text-secondary dark:text-dark-text-secondary">
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-8 items-start sm:items-center">
          <p className="whitespace-nowrap">
            ©{currentYear} ExoBengal. All rights reserved.
          </p>
